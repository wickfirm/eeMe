...
const BookPage: FC = () => {
    ...
    useEffect(() => {
        bookTalent(params.talent, currentLanguageCode).then(response => {
    ...
    return (
        <Fragment >
            ...
            />
            <Header page={BOOK_PAGE_ID} href={currentLanguageCode === 'en' ? '/ar/talent/' + talent?.slug.ar + '/book' : '/en/talent/' + talent?.slug.en + '/book'}  talent={currentLanguageCode === 'en' ? talent?.slug.ar : talent?.slug.en}/>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 mt-3">
                               ...
                               :  talent && talent.id && talent?.talent_order_types?.length  === 1 && talent && talent.price && talent.price.price && talent.talent_order_types[0].order_type === VIDEO_ORDER_TYPE ?
                                ...
                                <div className="talent-book-conditions mt-2">
